                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">Tk {{todaysell}}</div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">Tk {{income}}</div>
                                <div class="mt-2 mb-0 text-muted text-xs">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">Tk {{due}}</div>
                                <div class="mt-2 mb-0 text-muted text-xs">
                            ...
                            <div class="col-auto">
                                <i class="fas fa-exclamation-circle text-danger" style="position:relative; left: 38px; top: 6px;"></i>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">Tk {{expense}}</div>
                                <div class="mt-2 mb-0 text-muted text-xs">
                            ...
                            <div class="col-auto">
                                <!--<i class="fas fa-cog text-info" style="position:relative; left: 55px; top: 4px;"></i>-->

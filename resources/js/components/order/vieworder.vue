                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-4">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="table-responsive">
                                                    <ul class="list-group">
                                                        <li class="list-group-item"><b>Sub Total: </b> {{orders.sub_total}} <b>Tk</b></li>
                                                        <li class="list-group-item"><b>Vat: </b> {{orders.vat}} <b>%</b></li>
                                                        <li class="list-group-item"><b>Total Amount: </b> {{orders.total}} <b>Tk</b></li>
                                                        <li class="list-group-item"><b>Pay Amount: </b> {{orders.pay}} <b>Tk</b></li>
                                                        <li class="list-group-item"><b>Due Amount: </b> {{orders.due}} <b>Tk</b></li>
                                                    </ul>
                                                </div>
                                                <div class="card-footer"></div>
                                            </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table align-items-center table-flush">
                                                        ...
                                                        <tr v-for="detail in details">
                                                            ...
                                                            <td><img :src="'/'+detail.image" alt="" id="pr_photo"></td>
                                                            <td>{{detail.pro_quantity}}</td>
                                                            <td>{{detail.pro_price}} <b>Tk</b></td>
                                                            <td>{{detail.sub_total}} <b>Tk</b></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
